...
export const localClientExecutor = createAxiosExecutor(
  axios.create({ baseURL: LOCAL_API_BASE }),
);
export const localFetchExecutor = createFetchExecutor(LOCAL_API_BASE);
