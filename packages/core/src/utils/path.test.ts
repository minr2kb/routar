...
describe('resolvePath', () => {
  ...
  it('replaces multiple params', () => {
    expect(resolvePath('/users/:userId/posts/:postId', { userId: 42, postId: 7 }))
  ...
  it('throws for missing param', () => {
    expect(() => resolvePath('/todos/:id', {})).toThrow('Missing path parameter: id');
  });
  it('encodes special characters', () => {
    expect(resolvePath('/search/:q', { q: 'hello world' })).toBe('/search/hello%20world');
  });
});
